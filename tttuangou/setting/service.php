...
$config["service"] =  array (
  ...
  array (
    ...
    array (
      ...
      array (
        'name' => 'WN106通道',
        'intro' => '订单通知通道，禁发营销信息，70字单条，长短信67字条，须签名（签名联系天天微信客服：tttuangou 设置）<br/><a href="'.ihelper('tg.shop.sms.qxt').'" target="_blank"><font color="red">点此在线购买</font></a>',
      ),
      'zt' =>
      array (
        'name' => 'ZT106通道',
        'intro' => '<font color="red">【推荐】</font>可点对点下发，需做免审核备案<br>禁发抽奖、营销类信息，包括签名在内单条70个字，长短信每条67字（签名接口设置页自行设置，推荐用站点名称）<br/><a href="'.ihelper('tg.shop.sms.qxt').'" target="_blank"><font color="red">点此在线购买</font></a>',
      ),
	  'ums' =>
      array (
        'name' => 'ZJ165通道',
