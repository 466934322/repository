...
{reply}',
    ...
    'remind_seller_delivery' => 
    array (
      'struct' => 'orderid,productflag,paymoney,productnum,address_name,address_phone,address,extmsg',
      'name' => '提醒商家发货',
      ...
      'msg' => 
      array (
        'sms' => '产品：{productflag} 订单：{orderid} ，购买数{productnum}。用户已成功付款，收货人：{address_name}，联系电话：{address_phone}，收货地址：{address}，用户留言{extmsg}请尽快安排发货',
        'mail' => '产品：{productflag} 订单：{orderid} ，购买数{productnum}。用户已成功付款，收货人：{address_name}，联系电话：{address_phone}，收货地址：{address}，用户留言{extmsg}请尽快安排发货',
      ),
      'cfg' => 
      array (
        'sms' => 
    ...
    array (
      ...
      'msg' => 
      array (
        'sms' => '您在商家：{username} 消费：{money}元请确认是否为本人操作',
        'mail' => '您在商家：{username} 消费：{money}元请确认是否为本人操作',
      ),
      'cfg' => 
      array (
        'sms' => 
