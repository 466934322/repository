...
class AlipaySubmit {
	...
	function buildRequestForm($para_temp, $method, $button_name) {
		...
		$sHtml = "<form id='pay_submit' name='pay_submit' action='".$this->alipay_gateway_new."_input_charset=".trim(strtolower($this->alipay_config['input_charset']))."' method='".$method."'>";
		while (list ($key, $val) = each ($para)) {
            $sHtml.= "<input type='hidden' name='".$key."' value='".$val."'/>";
        }

		        $sHtml = $sHtml.'<input type="submit" value="支付宝付款" class="formbutton formbutton_ask"></form>';
