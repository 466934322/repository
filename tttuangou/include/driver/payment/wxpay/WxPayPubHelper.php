...
class Wxpay_client_pub extends Common_util_pub 
{
	...
	function createXml()
	{
	   	$this->parameters["appid"] = $this->appid;	   	$this->parameters["mch_id"] = $this->mchid;	    $this->parameters["nonce_str"] = $this->createNoncestr();	    $this->parameters["sign"] = $this->getSign($this->parameters);	    return  $this->arrayToXml($this->parameters);
	}
	...
	function createXml()
	{
		try
		{
						if($this->parameters["out_trade_no"] == null) 
			{
		   	...
		   	$this->parameters["appid"] = $this->appid;		   	$this->parameters["mch_id"] = $this->mchid;		   	$this->parameters["spbill_create_ip"] = $_SERVER['REMOTE_ADDR'];		    $this->parameters["nonce_str"] = $this->createNoncestr();		    $this->parameters["sign"] = $this->getSign($this->parameters);
	...
	{		
		try 
		{
			if($this->parameters["bill_date"] == null ) 
			{
		   	...
		   	$this->parameters["appid"] = $this->appid;		   	$this->parameters["mch_id"] = $this->mahid;		    $this->parameters["nonce_str"] = $this->createNoncestr();		    $this->parameters["sign"] = $this->getSign($this->parameters);		    return  $this->arrayToXml($this->parameters);
		}catch (SDKRuntimeException $e)
		{
			die($e->errorMessage());
		}
...
class NativeCall_pub extends Wxpay_server_pub
{
	...
	function createXml()
	{
		if($this->returnParameters["return_code"] == "SUCCESS"){
		   	$this->returnParameters["appid"] = $this->appid;		   	$this->returnParameters["mch_id"] = $this->mchid;		    $this->returnParameters["nonce_str"] = $this->createNoncestr();		    $this->returnParameters["sign"] = $this->getSign($this->returnParameters);		}
		return $this->arrayToXml($this->returnParameters);
	}
	...
	function createLink()
	{
		...
		{		
			if($this->parameters["product_id"] == null) 
			{
		   	...
		   	$this->parameters["appid"] = $this->appid;		   	$this->parameters["mch_id"] = $this->mchid;		   	$time_stamp = time();
