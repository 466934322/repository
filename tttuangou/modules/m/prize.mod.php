...
class ModuleObject extends MasterObject
{
	function ModuleObject( $config )
	{
		...
		if (MEMBER_ID < 1)
		{
			if (get('pid'))
			{
				header('Location: m.php?view='.get('pid'));
				exit;
			}
	...
	function View()
	{
		...
		include handler('template')->file('@m/prize_view');
	}
