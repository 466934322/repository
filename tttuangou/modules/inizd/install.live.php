...
function install_links()
{
	...
	if (!$zzxgj)
	{
		$zzxgj_link_list = array(
			array (
				'name' => _getaarrayrandval(array('免费微商城系统','免费移动电商和营销','免费移动电商平台','免费微信o2o系统','免费微信拼团系统','免费微营销和微商城','免费微信三级分销系统',)),
				'url' => 'http:/'.'/www.haoyebao.com',
			),
			array (
				'name' => _getaarrayrandval(array('免费移动社区系统','免费微社区系统','天天社群系统','免费社区系统','免费地方社区APP',)),
				'url' => 'http:/'.'/shequn.tttuangou.net',
			),
			array (
				'name' => _getaarrayrandval(array('PHP商城系统','同城配送系统','php外卖系统','外卖网站系统','开源团购程序','o2o源码下载','o2o系统下载',)),
