...
function install_step(n)
{
	...
	$.get('inizd.php?mod=install&code=process&op='+action+$.rnd.stamp(), function(data){
...
{
	$.get('inizd.php?mod=install&code=process&op=lives'+$.rnd.stamp(), function(data){});
}
