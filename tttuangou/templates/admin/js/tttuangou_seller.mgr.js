...
$(document).ready(function(){
    ...
    loadSellers(__Default_CityID, __Default_UpSellerID);
});
...
function loadSellers(cid, sid) {
    ...
    $.get('ajax.php?mod=getseller&code=getupseller&area='+cid+'&seller='+sid+'&sid='+__Global_SID+$.rnd.stamp(), function(data) {
        $('#upSellerList').html(data);
    });
}
